...
class Ui_ExportImageDialog(object):
    def setupUi(self, ExportImageDialog):
        ...
        ExportImageDialog.resize(340, 226)
        ...
        self.frameRangeGroupBox.setGeometry(QtCore.QRect(10, 40, 321, 111))
        ...
        self.frameCurrentRadio.setGeometry(QtCore.QRect(10, 20, 121, 20))
