...
class Ui_ExportImageDialog(object):
    def setupUi(self, ExportImageDialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(20, 330, 301, 32))
        ...
        self.includeFooterCheckbox.setGeometry(QtCore.QRect(20, 300, 121, 21))
        ...
        self.frameDelayGroup.setGeometry(QtCore.QRect(10, 200, 261, 91))
