...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cursorProbeLocation.sizePolicy().hasHeightForWidth())
        self.cursorProbeLocation.setSizePolicy(sizePolicy)
        ...
        self.cursorProbeText.setMinimumSize(QtCore.QSize(185, 0))
        ...
        self.cursorProbeLayer.setMinimumSize(QtCore.QSize(280, 0))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Andale Mono"))
        font.setPointSize(14)
        ...
        self.layerDetailsContents.setGeometry(QtCore.QRect(0, 0, 182, 76))
        ...
        self.timelinePane.setFloating(True)
        self.timelinePane.setFeatures(QtGui.QDockWidget.DockWidgetFloatable|QtGui.QDockWidget.DockWidgetMovable)
        ...
        self.timelineToolGroup = QtGui.QGroupBox(self.dockWidgetContents_2)
        self.timelineToolGroup.setMinimumSize(QtCore.QSize(0, 12))
        self.timelineToolGroup.setBaseSize(QtCore.QSize(0, 12))
        self.timelineToolGroup.setTitle(_fromUtf8(""))
        self.timelineToolGroup.setObjectName(_fromUtf8("timelineToolGroup"))
        self.timelineShowOnlyActive = QtGui.QCheckBox(self.timelineToolGroup)
        self.timelineShowOnlyActive.setGeometry(QtCore.QRect(10, 10, 85, 18))
        self.timelineShowOnlyActive.setObjectName(_fromUtf8("timelineShowOnlyActive"))
        self.timelineTimeResolution = QtGui.QSlider(self.timelineToolGroup)
        self.timelineTimeResolution.setGeometry(QtCore.QRect(20, 20, 160, 22))
        self.timelineTimeResolution.setOrientation(QtCore.Qt.Horizontal)
        self.timelineTimeResolution.setObjectName(_fromUtf8("timelineTimeResolution"))
        self.verticalLayout_9.addWidget(self.timelineToolGroup)
        self.timelineView = QtGui.QGraphicsView(self.dockWidgetContents_2)
        self.timelineView.setMinimumSize(QtCore.QSize(64, 12))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cursorProbeLayer.setText(_translate("MainWindow", "Current Layer: N/A", None))
        ...
        self.timelineShowOnlyActive.setText(_translate("MainWindow", "Show ActiveOnly", None))
