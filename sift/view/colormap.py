...
'#000000', '#020202', '#ac7070', '#a18331', '#41a166', '#211d8a', '#211d89', '#05f7fb', '#fbf702', '#fb0000', '#ffffff')
...
'#00aac7', '#008cab', '#ffffff', '#0087a6', '#007597', '#005a82', '#005981', '#7f7f7f', '#8a8a8a', '#8b8b8b', '#ff0000',
'#ff0000')
...
_rain_rate_colors = (
'#000000', '#c7c7c7', '#00ffff', '#0000ff', '#00ff00', '#ffff00', '#ff9500', '#e20000', '#f00000', '#ff00ff', '#ffffff')
...
_ir_wv_colors = (
'#000000', '#f5f5f5', '#df0000', '#94009a', '#8a008a', '#00c4ce', '#006d00', '#d5d5d5', '#000076', '#350016', '#ffffff')
...
'#000000', '#412a0e', '#7876cf', '#7b79d4', '#767502', '#706f02', '#ea0000', '#f10000', '#f575c7', '#c6c6c5', '#ffffff')
...
0.40784313725490196, 0.4627450980392157, 0.4666666666666667, 0.5215686274509804, 0.6392156862745098, 0.6431372549019608,
0.6941176470588235, 0.7803921568627451, 1.0)
_lifted_index_default_colors = (
'#000000', '#7f1818', '#0abf06', '#07c405', '#7382c3', '#7b8cc6', '#ca9444', '#bac005', '#bec403', '#ca84c0', '#c37801',
...
0.8352941176470589, 0.8588235294117647, 0.8823529411764706, 0.9294117647058824, 0.9333333333333333, 0.9803921568627451,
0.9882352941176471, 1.0)
_blended_total_precip_water_colors = (
'#000000', '#db9270', '#0000c4', '#00e7e7', '#00ffff', '#00f300', '#00ff00', '#b9b900', '#ffff00', '#f30000', '#ff0000',
...
0.6431372549019608, 0.7019607843137254, 0.7098039215686275, 0.7450980392156863, 0.7764705882352941, 0.7803921568627451,
0.984313725490196, 1.0)
_percent_of_normal_tpw_colors = (
'#000000', '#875a45', '#94634c', '#c08062', '#ecc9b7', '#05ffff', '#00dbdb', '#00b4b4', '#00b0b0', '#009999', '#008484',
...
'#000000', '#4c3516', '#9390f2', '#0a675e', '#9fc33c', '#f3775c', '#f77a5e', '#700071', '#ffc2fc', '#c6c6c6', '#ffffff')
...
'#000000', '#850200', '#ca2b00', '#ca9117', '#6bac1f', '#22ac4a', '#279fa1', '#821ba1', '#2629a6', '#1e1fa1', '#ca4205',
...
'#000000', '#cc5111', '#cc5211', '#f6e207', '#faeb07', '#1aaf03', '#03edd9', '#0523ff', '#0517ff', '#fcedff', '#1afcff',
'#13fcff', '#ffffff')
...
'#000000', '#020202', '#9d3c5e', '#9d4c00', '#9d9900', '#1a8c63', '#211d8b', '#211d8a', '#05f8fc', '#fcf802', '#fc0000',
'#ffffff')
...
'#000000', '#9e0000', '#7f0000', '#9e3f00', '#9e7f00', '#529e00', '#2bad00', '#00be45', '#009e6a', '#006a9e', '#a6a6a6',
'#ffffff')
...
0.8274509803921568, 0.8627450980392157, 0.8862745098039215, 0.8901960784313725, 0.9137254901960784, 0.9254901960784314,
1.0)
_slc_wv_colors = (
'#000000', '#995c35', '#3a3835', '#759285', '#166f4c', '#076a44', '#036842', '#008484', '#00b0b0', '#00b6b6', '#009300',
'#006c00', '#ffffff')
...
0.4991652754590985, 0.5025041736227045, 0.666110183639399, 0.669449081803005, 0.8330550918196995, 0.8363939899833055,
1.0)
_rrqpe_colors = (
'#000000', '#fd7efd', '#9a1a9a', '#7ecafd', '#1a679a', '#7efd7e', '#1a9a1a', '#fdfd7e', '#9a9a1a', '#fdca7e', '#9a671a',
'#fd7e7e', '#9a1a1a')
...
0.4555229716520039, 0.5356793743890518, 0.6275659824046921, 0.7047898338220919, 0.7497556207233627, 0.852394916911046,
1.0)
_colorhpw10h10_colors = (
'#3b2709', '#d9a675', '#9696fa', '#4f4f96', '#006363', '#73a427', '#92bf3a', '#ffff00', '#ff8263', '#962727', '#630063',
'#ef00ef', '#fec7fe')
...
0.3782991202346041, 0.4467253176930596, 0.5249266862170088, 0.5904203323558163, 0.6275659824046921, 0.7145650048875856,
0.8387096774193549, 0.8582600195503421, 0.9345063538611925, 1.0)
_colorhpw8h10_colors = (
'#422c0d', '#d9a675', '#9595f8', '#4f5095', '#006363', '#73a427', '#90be3b', '#ffff00', '#ff8263', '#952728', '#630063',
...
0.7625793844650708, 0.8236443575964827, 0.8847093307278945, 0.9574987787005373, 0.9960918417195896, 0.9970688812896922,
1.0)
_ir_color_clouds_summer_colors = (
'#000000', '#c1c1c1', '#00fcfd', '#000073', '#00ff00', '#ffff00', '#ff0000', '#000000', '#e6e6e6', '#7f007f', '#13daec',
'#06ced4', '#000000')
...
0.6951636541279922, 0.7625793844650708, 0.8236443575964827, 0.8847093307278945, 0.9574987787005373, 0.9960918417195896,
0.9970688812896922, 1.0)
_ir_color_clouds_winter_colors = (
'#000000', '#010101', '#c1c1c1', '#00fafc', '#000073', '#00ff00', '#ffff00', '#ff0000', '#000000', '#e6e6e6', '#7f007f',
...
0.31411822178798243, 0.3761602344894968, 0.4386907669760625, 0.5012212994626283, 0.563751831949194, 0.6257938446507083,
0.688324377137274, 0.7513434294088911, 0.8754274548119199, 1.0)
_rainbow_11_bit_colors = (
'#7e0000', '#000000', '#803e1e', '#ff0000', '#ff7e7e', '#ffff00', '#7eff7e', '#00ff00', '#007e7e', '#00ffff', '#7e7eff',
...
'#000000', '#5f5f5f', '#824513', '#834614', '#fddcb1', '#ffdeae', '#ffffff', '#0000ff', '#ffff00', '#ff0000', '#ff00ff',
'#ff00ff')
...
0.37664875427454814, 0.5012212994626283, 0.5642403517342452, 0.626770884220811, 0.6888128969223254, 0.7513434294088911,
0.8754274548119199, 1.0)
_enhancedhrainbowh11_colors = (
'#7e0000', '#000000', '#803e1e', '#ff0000', '#feff00', '#7efe00', '#007e00', '#00ffff', '#007efe', '#00007e', '#800080',
...
0.5668703326544468, 0.653428377460964, 0.6972165648336728, 0.7406653088934148, 0.7837746096401901, 0.8272233536999322,
0.9134419551934827, 1.0)
_enhancedhrainbow_warmer_yellow_colors = (
'#ffff00', '#000000', '#803e1f', '#ff0000', '#fdff00', '#7efd00', '#007f00', '#00ffff', '#007efd', '#01007f', '#800080',
...
0.6463980463980464, 0.6468864468864469, 0.702075702075702, 0.7074481074481075, 0.768986568986569, 0.7746031746031746,
0.7777777777777778, 0.7841269841269841, 0.7882783882783883, 0.7914529914529914, 0.7963369963369963, 0.8024420024420025,
0.8083028083028083, 0.8146520146520146, 0.819047619047619, 0.8219780219780219, 0.8268620268620268, 0.832967032967033,
0.8412698412698413, 0.8417582417582418, 0.8844932844932845, 0.8901098901098901, 0.8905982905982905, 0.9455433455433455,
0.9514041514041514, 0.9518925518925518, 1.0)
_ramsdis_ir_12bit_colors = (
'#080808', '#ffffff', '#fdfd00', '#646400', '#8c6400', '#8e0000', '#f1007b', '#f100f6', '#8b008c', '#005e90', '#00cad0',
'#0bf800', '#0bf100', '#0ae200', '#09d900', '#08d200', '#07c700', '#06b900', '#05ac00', '#049e00', '#039400', '#028d00',
'#018200', '#007500', '#006f00', '#000000', '#d8d8d8', '#d8d8f6', '#0000f8', '#000066', '#7b0076', '#f50076', '#010000')
...
0.4818070818070818, 0.4822954822954823, 0.48473748473748474, 0.6156288156288157, 0.6161172161172161, 0.64004884004884,
0.6405372405372405, 0.701098901098901, 0.7015873015873015, 0.7621489621489621, 0.7626373626373626, 0.8234432234432234,
0.8656898656898657, 0.8661782661782662, 0.8717948717948718, 0.8722832722832723, 0.884004884004884, 0.8844932844932845,
0.945054945054945, 0.9455433455433455, 1.0)
_ramsdis_wv_12bit_colors = (
'#050500', '#313100', '#181800', '#000000', '#454500', '#c8c800', '#fd4a4a', '#211212', '#4b0000', '#e20000', '#ff7e00',
'#4b0000', '#430606', '#222222', '#ffffff', '#6496c8', '#4d7eb1', '#000064', '#0000fe', '#006400', '#00fe00', '#640000',
'#ffff00', '#8a8a35', '#ffffff', '#ffffff', '#636347', '#4e4e50', '#ffffff', '#4e4e33', '#000031', '#000031')
