...
class Main(QtGui.QMainWindow):
    ...
    def setup_key_releases(self):
        ...
        self.scene_manager.main_canvas.events.key_release.connect(cb_factory("a", self.scene_manager.image_list.toggle_animation))
        self.scene_manager.main_canvas.events.key_release.connect(cb_factory("n", self.scene_manager.image_list.next_frame))
