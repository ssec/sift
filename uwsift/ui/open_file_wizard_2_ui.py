...
class Ui_openFileWizard(object):
    def setupUi(self, openFileWizard):
        ...
        self.resolutionXSpinBox = QtWidgets.QSpinBox(self.productSelectionPage)
        self.resolutionXSpinBox.setMinimum(1)
        self.resolutionXSpinBox.setMaximum(100000)
        self.resolutionXSpinBox.setProperty("value", 1000)
        self.resolutionXSpinBox.setObjectName("resolutionXSpinBox")
        self.productSelectionButtonLayout.addWidget(self.resolutionXSpinBox)
        self.resolutionYSpinBox = QtWidgets.QSpinBox(self.productSelectionPage)
        self.resolutionYSpinBox.setMinimum(1)
        self.resolutionYSpinBox.setMaximum(100000)
        self.resolutionYSpinBox.setProperty("value", 1000)
        self.resolutionYSpinBox.setObjectName("resolutionYSpinBox")
        self.productSelectionButtonLayout.addWidget(self.resolutionYSpinBox)
