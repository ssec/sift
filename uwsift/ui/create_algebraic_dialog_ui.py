...
class Ui_create_algebraic_dialog(object):
    ...
    def retranslateUi(self, create_algebraic_dialog):
        ...
        create_algebraic_dialog.setWindowTitle(_translate("create_algebraic_dialog", "Create Algebraic Layer"))
        self.operations_text.setPlainText(_translate("create_algebraic_dialog", "result = x - y"))
        self.name_label.setText(_translate("create_algebraic_dialog", "Name:"))
        self.operation_label.setText(_translate("create_algebraic_dialog", "Operation:"))
        self.x_label.setText(_translate("create_algebraic_dialog", "x:"))
        self.y_label.setText(_translate("create_algebraic_dialog", "y:"))
        self.z_label.setText(_translate("create_algebraic_dialog", "z:"))
        self.operations_label.setText(_translate("create_algebraic_dialog", "Operations"))
