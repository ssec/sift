...
class Ui_openFileWizard(object):
    def setupUi(self, openFileWizard):
        ...
        self.productTypeGroup = QtWidgets.QButtonGroup()
        self.productTypeAll = QtWidgets.QRadioButton("All")
        self.productTypeSingle = QtWidgets.QRadioButton("Single")
        self.productTypeComposite = QtWidgets.QRadioButton("Composite")
        self.productTypeGroup.addButton(self.productTypeAll, 0)
        self.productTypeGroup.addButton(self.productTypeSingle, 1)
        self.productTypeGroup.addButton(self.productTypeComposite, 2)
        self.productTypeAll.setChecked(True)
        self.productSelectionButtonLayout.addWidget(self.productTypeAll)
        self.productSelectionButtonLayout.addWidget(self.productTypeSingle)
        self.productSelectionButtonLayout.addWidget(self.productTypeComposite)
