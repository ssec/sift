...
class Ui_ExportImageDialog(object):
    def setupUi(self, ExportImageDialog):
        ...
        ExportImageDialog.resize(342, 490)
        ...
        self.buttonBox.setGeometry(QtCore.QRect(180, 450, 161, 32))
        ...
        self.frameDelayGroup_2.setGeometry(QtCore.QRect(10, 340, 161, 131))
        ...
        self.colorbarHorizontalRadio.setGeometry(QtCore.QRect(10, 60, 91, 21))
        ...
        self.colorbarVerticalRadio.setGeometry(QtCore.QRect(10, 90, 81, 21))
        self.colorbarVerticalRadio.setObjectName("colorbarVerticalRadio")
        self.layoutWidget = QtWidgets.QWidget(ExportImageDialog)
        self.layoutWidget.setGeometry(QtCore.QRect(190, 370, 136, 51))
        ...
        self.verticalLayout.addWidget(self.includeFooterCheckbox)
