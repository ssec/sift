...
class Ui_datasetStatisticsPane(object):
    def setupUi(self, datasetStatisticsPane):
        ...
        self.roundingPrecisionLabel = QtWidgets.QLabel(datasetStatisticsPane)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.roundingPrecisionSpinBox)
