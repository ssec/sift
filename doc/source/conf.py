...
from uwsift import __version__  # noqa
...
project = "SIFT"
copyright = "{:%Y}, University of Wisconsin Regents".format(datetime.utcnow())
...
latex_documents = [
    (master_doc, "SIFT.tex", "SIFT Documentation", "SIFT Developers", "manual"),
]
...
man_pages = [(master_doc, "sift", "SIFT Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "SIFT", "SIFT Documentation", author, "SIFT", "One line description of project.", "Miscellaneous"),
]
